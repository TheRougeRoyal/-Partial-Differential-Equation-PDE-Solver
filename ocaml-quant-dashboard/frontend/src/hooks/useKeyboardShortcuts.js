...
export const KEYBOARD_SHORTCUTS = [
  ...
  { keys: 'g → o', description: 'Go to Derivatives Chain' },
  { keys: 'g → r', description: 'Go to Pricing Engine' },
  { keys: 'g → s', description: 'Go to Algo Signals' },
  { keys: 'g → x', description: 'Go to Execution Blotter' },
  { keys: 'g → b', description: 'Go to Strategy Lab' },
  { keys: 'g → l', description: 'Go to Trading Desk' },
  { keys: 't', description: 'Toggle Theme' },
  { keys: 'Ctrl+N', description: 'Route Order' },
